...
def main():
    ...
    inverted_index, doc_metadata, docs, doc_vectors, vocab, doc_corr = build_index(html_files)
    search_engine_gui( inverted_index, doc_metadata, docs, doc_vectors, vocab,  doc_corr)
